# Phase 15 constraints: one 50 MHz clock, asynchronous reset, modest IO delays.
# Used for both the PnR and signoff phases; the values are relative to
# CLOCK_PERIOD so the same file works at any target frequency.
