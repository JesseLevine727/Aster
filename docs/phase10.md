...
- [ ] All applicable Phase 1–9 regressions and `make check` remain green (the xe regression and host tests are wired into `make check`; a full clean `make check` is the remaining gate).
